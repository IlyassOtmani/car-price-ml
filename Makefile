...
HfApi().create_repo(repo_id='Sharker555/car-price-predictor', repo_type='space', space_sdk='gradio', token='$(HF)', exist_ok=True); \
HfApi().upload_folder(folder_path='App', path_in_repo='.', repo_id='Sharker555/car-price-predictor', repo_type='space', token='$(HF)')"
